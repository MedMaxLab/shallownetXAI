...
if __name__ == '__main__':
    ...
    if 'alzheimerbl' in taskToEval.casefold():
        a_id = list(range(301, 336))  # 201–235 inclusive

        c_id = list(range(101, 113)) + [114, 115, 116, 117, 118, 120, 121, 122, 124, 126, 128, 129, 130, 131, 133, 134, 135, 137, 138, 143]

        f_id = list(range(201, 220))  # 101–119 inclusive
    ...
    elif 'alzheimer' in taskToEval.casefold():
    ...
    if taskToEval.casefold() == 'alzheimerbl':
        nb_classes = 3
    ...
    elif taskToEval.casefold() == 'alzheimerbl':
        class_labels = ['CTL', 'FTD', 'AD']
    ...
    # They will be used by GetTable to perform a subject based split
    ...
    if ('alzheimer' in taskToEval.casefold()) or ('cognitive' in taskToEval.casefold()) or taskToEval.casefold()=="alzheimerbl":
        if taskToEval.casefold() == 'alzheimerca':
    ...
    if taskToEval.casefold()=="alzheimer" or ('cognitive' in taskToEval.casefold()) or taskToEval.casefold()=="alzheimerbl":
        if subjectTrain:
            if appleLoss:
    ...
    if taskToEval.casefold() == 'alzheimer':
        ...
        start_piece_mdl = 'AlzBLClassification/Models/'
        start_piece_res = 'AlzBLClassification/Results/'
        task_piece = 'alzbl'
